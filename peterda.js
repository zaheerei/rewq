...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) { 
    ...
    console.log(`@serverpie`.bgRed.bold.white);
    console.log(`============================================`.gray);
    console.log(`🚀 Target: `.brightMagenta + process.argv[2].brightWhite);
    console.log(`⏳ Time: `.brightMagenta + process.argv[3].brightWhite);
    console.log(`⚡ Rate: `.brightMagenta + process.argv[4].brightWhite);
    console.log(`🧵 Thread: `.brightMagenta + process.argv[5].brightWhite);
    console.log(`📂 ProxyFile: `.brightMagenta + process.argv[6].brightWhite);
    console.log(`============================================`.gray);
    console.log(`🔥 Methods By Serverpie`.brightCyan.bold);
